...
test("query serializes Gateway-owned tool_policy and rejects host sandbox settings", async () => {
  ...
  await assert.rejects(() => hostProfile.next(), { code: "unsupported_capability" });
