...
export const CATALOG_PROVIDERS: CatalogProvider[] = [
  ...
  },
  {
    ...
    modelListUrl: 'https://chatgpt.com/backend-api/codex/models',
    requiresApiKey: false,
    models: [
      { id: 'gpt-5.6-sol', displayName: 'GPT-5.6 Sol', supportsImage: true, maxContextTokens: 272000, maxOutputTokens: 128000 },
      { id: 'gpt-5.6-sol-pro', displayName: 'GPT-5.6 Sol Pro', supportsImage: true, maxContextTokens: 272000, maxOutputTokens: 128000 },
      { id: 'gpt-5.6-terra', displayName: 'GPT-5.6 Terra', supportsImage: true, maxContextTokens: 272000, maxOutputTokens: 128000 },
      { id: 'gpt-5.6-terra-pro', displayName: 'GPT-5.6 Terra Pro', supportsImage: true, maxContextTokens: 272000, maxOutputTokens: 128000 },
      { id: 'gpt-5.6-luna', displayName: 'GPT-5.6 Luna', supportsImage: true, maxContextTokens: 272000, maxOutputTokens: 128000 },
      { id: 'gpt-5.6-luna-pro', displayName: 'GPT-5.6 Luna Pro', supportsImage: true, maxContextTokens: 272000, maxOutputTokens: 128000 },
      { id: 'gpt-5.5', displayName: 'GPT-5.5', supportsImage: true, maxContextTokens: 272000, maxOutputTokens: 128000 },
      { id: 'gpt-5.4-mini', displayName: 'GPT-5.4 Mini', supportsImage: true, maxContextTokens: 272000, maxOutputTokens: 128000 },
      { id: 'gpt-5.4', displayName: 'GPT-5.4', supportsImage: true, maxContextTokens: 272000, maxOutputTokens: 128000 },
      { id: 'gpt-5.3-codex', displayName: 'GPT-5.3 Codex', supportsImage: true, maxContextTokens: 272000, maxOutputTokens: 128000 },
      { id: 'gpt-5.3-codex-spark', displayName: 'GPT-5.3 Codex Spark', supportsImage: true, maxContextTokens: 128000, maxOutputTokens: 128000 },
    ],
  },
  {
    id: 'openai',
