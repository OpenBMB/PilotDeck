...
const attachmentUploadLimits = readAttachmentUploadLimits();
const maxFileBytes = envNumber('PILOTDECK_UPLOAD_MAX_FILE_BYTES')
  ?? attachmentUploadLimits.maxFileSizeBytes;
const maxFiles = envNumber('PILOTDECK_UPLOAD_MAX_FILES')
...
const store = new UploadStore({
  ...
  maxFileBytes,
  maxTaskBytes: envNumber('PILOTDECK_UPLOAD_MAX_TASK_BYTES') ?? maxFileBytes * maxFiles,
  maxFiles,
...
const uploadContent = multer({ storage, limits: { files: maxFiles, fields: 20 } }).any();
