...
适用基线：`origin/main` 提交 `cfc4d1779228f91fececc5d6705c14dab5b7ef2f` 及其后的 standalone SDK 开发
...
- Gateway protocol 的 schema、version、capability、request/response/event envelope；
...
| operation | Gateway/embedding host | 透传 identity，不自行改写终态 |
